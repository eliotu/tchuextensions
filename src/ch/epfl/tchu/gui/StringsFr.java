...
public final class StringsFr {
    ...
    public static final String LONGEST ="le %s a le plus long trajet (%s)";
    public static final String TICKET_POINTS ="Vos tickets vous donne %s points";
    ...
    public static String plural(int value) {
        return value == 0 ? "" : Math.abs(value) == 1 ? "" : "s";
    }
}
