...
public final class Constants {
    ...
    public static final int VOLEUR_CARDS_COUNT = 8;


    /**
     * Nombre total de cartes wagon/locomotive.
     */
    public static final int TOTAL_CARDS_COUNT =VOLEUR_CARDS_COUNT+
    ...
    private static SortedBag<Card> computeAllCards() {
        ...
        cardsBuilder.add(SortedBag.of(LOCOMOTIVE_CARDS_COUNT, Card.LOCOMOTIVE,VOLEUR_CARDS_COUNT,Card.VOLEUR));
    ...
    public static final double Y_1=619;
    public static final double Y_2=517;
    public static final double Y_3=417;
    public static final double Y_4=315;
    public static final double Y_5=215;


    public static final int X_BLACK=-897;
    public static final int X_VIOLET=-824;
    public static final int X_BLUE=-754;
    public static final int X_GREEN=-683;
    public static final int X_YELLOW=-612;
    public static final int X_ORANGE=-541;
    public static final int X_RED=-470;
    public static final int X_WHITE=-398;
    public static final int X_LOCO=-328;
    public static final int X_VOLEUR=-257;
